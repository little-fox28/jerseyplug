...
<div class="bg-white border border-gray-200 rounded-[2rem] p-6 md:p-10 shadow-sm overflow-hidden max-w-4xl mx-auto">
    <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mb-8">
        <?php echo esc_html( jerseyplug_pll( 'Account details' ) ); ?>
    </h2>
	...
	<form class="woocommerce-EditAccountForm edit-account flex flex-col gap-6" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex flex-col gap-2">
                <label class="text-sm font-bold text-slate-700" for="account_first_name"><?php echo esc_html( jerseyplug_pll( 'First name' ) ); ?> <span class="text-red-500">*</span></label>
            ...
            <div class="flex flex-col gap-2">
                <label class="text-sm font-bold text-slate-700" for="account_last_name"><?php echo esc_html( jerseyplug_pll( 'Last name' ) ); ?> <span class="text-red-500">*</span></label>
        ...
        <div class="flex flex-col gap-2">
            <label class="text-sm font-bold text-slate-700" for="account_display_name"><?php echo esc_html( jerseyplug_pll( 'Display name' ) ); ?> <span class="text-red-500">*</span></label>
            ...
            <span class="text-xs text-gray-500 mt-1"><?php echo esc_html( jerseyplug_pll( 'This will be how your name will be displayed in the account section and in reviews' ) ); ?></span>
        </div>

        <div class="flex flex-col gap-2 mb-4">
            <label class="text-sm font-bold text-slate-700" for="account_email"><?php echo esc_html( jerseyplug_pll( 'Email address' ) ); ?> <span class="text-red-500">*</span></label>
		...
		<fieldset class="border border-gray-100 rounded-2xl p-6 bg-white shadow-sm flex flex-col gap-4 mt-2">
			<legend class="text-lg font-extrabold text-slate-900 px-2 uppercase tracking-wide"><?php echo esc_html( jerseyplug_pll( 'Password change' ) ); ?></legend>

            <div class="flex flex-col gap-2">
                <label class="text-sm font-bold text-slate-700" for="password_current"><?php echo esc_html( jerseyplug_pll( 'Current password (leave blank to leave unchanged)' ) ); ?></label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-bold text-slate-700" for="password_1"><?php echo esc_html( jerseyplug_pll( 'New password (leave blank to leave unchanged)' ) ); ?></label>
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-bold text-slate-700" for="password_2"><?php echo esc_html( jerseyplug_pll( 'Confirm new password' ) ); ?></label>
		...
		<div class="mt-4 pt-6 border-t border-gray-100">
			...
			<button type="submit" class="inline-flex items-center justify-center rounded-xl py-4 px-8 font-extrabold text-sm uppercase tracking-widest shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto text-[#f2c86c] bg-primary" name="save_account_details" value="<?php echo esc_attr( jerseyplug_pll( 'Save changes' ) ); ?>"><?php echo esc_html( jerseyplug_pll( 'Save changes' ) ); ?></button>
